...
const requestAnswerModal = document.querySelector('#my-answer-modal'); 
...
callBackForm.addEventListener('submit', function(event){
    ...
    requestAnswerModal.classList.add('modal-active');

    setTimeout(function(){
        requestAnswerModal.classList.remove('modal-active');
    }, 2000);
